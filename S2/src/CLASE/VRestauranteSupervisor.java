...
public class VRestauranteSupervisor extends JFrame implements ActionListener {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    VRestauranteSupervisor frame = new VRestauranteSupervisor();
